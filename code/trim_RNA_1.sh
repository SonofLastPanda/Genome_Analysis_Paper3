...
trimmomatic PE -threads 2 -phred33 -trimlog ../data/trimmed_data/log/trim_RNA_SRR4342193.log $DATA/SRR4342139.1.fastq.gz $DATA/SRR4342139.2.fastq.gz $OUT/SRR4342139_left_paired_trim.fastq.gz $OUT/SRR4342139_left_unpaired_trim.fastq.gz  $OUT/SRR4342139_right_paired_trim.fastq.gz  $OUT/SRR4342139_right_unpaired_trim.fastq.gz ILLUMINACLIP:/sw/apps/bioinfo/trimmomatic/0.36/milou/adapters/TruSeq3-PE.fa:2:30:10 LEADING:3 TRAILING:3 SLIDINGWINDOW:4:15 MINLEN:36
